...
asdoc -doc-sources+=src/main/flex -package-description-file scripts/package-description-core.xml -main-title "JuiceKit Data API Documentation" -output target/asdoc-output/
