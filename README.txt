This is the JuiceKit Encode library.
...
src/
	main/
		flex/  -- JuiceKit encoding library code
	test/
		flex/  -- JuiceKit encoding Flex4 unit tests
...
Instructions to use juicekit-flex-encode as a dependency in a Maven-based project are coming
soon.
...
## To compile with Maven
	...
	[INFO] ------------------------------------------------------------------------
	[INFO] Building JuiceKit Flex Encode Library
