...
package org.juicekit.collections {
	...
	import org.juicekit.encoder.OperatorList;
	import org.juicekit.util.Property;
	import org.juicekit.util.Stats;
	
	
	/**
	 * The JKArrayCollection class is a wrapper class that exposes an ArrayCollection.
	 ...
	 *
	 **/
	public class JKArrayCollection extends ArrayCollection {
		 ...
		 * Constructor
		 */
		public function JKArrayCollection(source:Array = null) {
			super(source);
		}
		...
		public var operatorList:OperatorList = new OperatorList();
